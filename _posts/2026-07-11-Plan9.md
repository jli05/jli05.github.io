...
# Installation
Let's install it on a virtual machine on x86_64 for example. Download the cdrom image `9front-xxxxx.amd64.iso.gz` from [https://9front.org/iso/](https://9front.org/iso/). Decompress it. Refer to qemu [system invoation](https://www.qemu.org/docs/master/system/invocation.html) for its usage.
